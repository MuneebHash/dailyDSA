...
public class CheckPrime {
    public Boolean prime(int n){
        if (n <= 1) return false; // Exclude numbers <= 1
        // iterate from 2 to sqrt(n) because any factor greater than sqrt(n) would already have a corresponding factor below it.
